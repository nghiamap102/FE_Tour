...
var hide = function (modal) {
    ...
    if (!hideModalCallbacks[modalId]) {
        ...
        //eslint-disable-next-line @typescript-eslint/ban-ts-comment
        //@ts-ignore
        hideModalCallbacks[modalId] = { resolve: theResolve_2, reject: theReject_2, promise: promise };
    }
...
var useModal = function () {
    ...
    return react_1.useMemo(function () { return ({
        ...
        show: function (args) { return exports.show(mid, args); },
        hide: function () { return exports.hide(mid); },
        remove: function () { return exports.remove(mid); },
...
var create = function (Comp) {
    return function (_a) {
        ...
        var _c = exports.useModal(id), args = _c.args, show = _c.show;
